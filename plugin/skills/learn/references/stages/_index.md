...
| 4 课程大纲 | `courses/<id>/outline.md` + `lesson-plan.json`（`outline_confirmed_at`） | [outline.md](outline.md) | 该课已有确认过的大纲 |
| 5 生成 units → 前置 → 教学 | `units/`、进度、知识库 | learn SKILL.md §4–§7 | — |
...
本课无 lesson-plan.json 或 outline_confirmed_at 为 null → 阶段 4
否则 → 阶段 5
```
